export default function Education() {
    return (
      <>
        <div className="main text-base-100 rounded-xl 
          ...
          <div className="content gap-8">
            ...
            <div className="flex justify-between">
                  ...
                  <ul className="list-disc pl-6">
                    ...
                    >Bachelor of Business Administration : Human Resource Management</li>
            ...
            <div className="flex justify-between">
                ...
                <ul className="list-disc pl-6">
                  <li className="list-none ml-[-24px] text-base-100/60">Computer Science (Chiang Rai)</li>
