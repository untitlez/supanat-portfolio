        ...
        <div className='main'>
            ...
            <h6>TECHNICAL SKILLS</h6>
              ...
              <div className="grid gap-2 ">
                  ...
                  target="_blank">
                  <img src="/src/assets/icon/figma.png" alt="icon_location" />
                  Figma
                  </a>

                  {/* VS Code  */}
                  <div className="flex items-center gap-4">
                  <img className="size-6" src="/src/assets/icon/vs code.png" alt="icon_location" />
                  <p>VS Code</p>
                  </div>

                  {/* HTML  */}
                  <div className="contact">
                  <img className="size-6" src="/src/assets/icon/html.png" alt="icon_location" />
                  <p>HTML</p>
                  </div>

                  {/* CSS  */}
                  <div className="flex items-center gap-4">
                  <img className="size-6" src="/src/assets/icon/css.png" alt="icon_location" />
                  <p>CSS</p>
                  </div>

                  {/* JavaScript  */}
                  <div className="flex items-center gap-4">
                  <img className="size-6" src="/src/assets/icon/js.png" alt="icon_location" />
                  <p>JavaScript</p>
                  </div>

                  {/* React  */}
                  <div className="flex items-center gap-4">
                  <img className="size-6" src="/src/assets/icon/react.png" alt="icon_location" />
                  <p>React</p>
                  </div>

                  {/* Tailwindcss  */}
                  <div className="flex items-center gap-4">
                  <img className="size-6" src="/src/assets/icon/tailwind.png" alt="icon_location" />
                  <p>Tailwind CSS</p>
                  </div>

                  {/* BootStrap  */}
                  <div className="flex items-center gap-4">
                  <img className="size-6" src="/src/assets/icon/bootstrap.png" alt="icon_location" />
                  <p>Bootstrap</p>
                  </div>
            ...
            <div className='primary rounded-[24px] text-white ctg px-12 py-16 gap-8 '>
              ...
              <div>
                  ...
                  target='_blank'>
                  <img className="size-6" src="/src/assets/icon/skooldio.png" alt="icon_location" />
                  Skooldio
                  </a>
              </div>
              </div>
