    ...
    <>
      <div className="main">
        ...
        <div className="grid gap-2 col-span-3">
            ...
            <img className="size-6" src="/src/assets/icon/location_on.png" alt="icon_location" />
            Chiang Mai, Thailand
            </div>

            {/* Mail */}
            <div className="flex items-center gap-4">
            <img className="size-6" src="/src/assets/icon/mail.png" alt="icon_Mail" />
            tleza_championship2@hotmail.com
            </div>

            {/* Phone  */}
            <div className="flex items-center gap-4">
            <img className="size-6" src="/src/assets/icon/call.png" alt="icon_Phone" />
            0882252252
            </div>

            {/* Birthdate  */}
            <div className="flex items-center gap-4">
            <img className="size-6" src="/src/assets/icon/cake.png" alt="icon_birthdate" />
            11 FEB 1994
            </div>
        </div>
        ...
        <div className="grid gap-2">
            ...
            <img src="/src/assets/icon/fb.png" alt="icon_facebook" />
            Facebook
            </a>
            ...
            <img src="/src/assets/icon/ig.png" alt="icon_instagram" />
            Instagram
            </a>
            ...
            target="_blank">
            <img src="/src/assets/icon/notion.png" alt="icon_notion" />
            Notion</a>
