    ...
    <>
      <div className="main">
        ...
        <div className="ctf p-12 aspect-[3/4] fin">
          <img src="/assets/img/profile.jpg" alt="image_profile" />
        </div>
        ...
        <div className="grid gap-2 col-span-3">
            ...
            <img className="size-6" src="/assets/icon/location_on.png" alt="icon_location" />
            Chiang Mai, Thailand
            </div>

            {/* Mail */}
            <div className="flex items-center gap-4">
            <img className="size-6" src="/assets/icon/mail.png" alt="icon_Mail" />
            tleza_championship2@hotmail.com
            </div>

            {/* Phone  */}
            <div className="flex items-center gap-4">
            <img className="size-6" src="/assets/icon/call.png" alt="icon_Phone" />
            0882252252
            </div>

            {/* Birthdate  */}
            <div className="flex items-center gap-4">
            <img className="size-6" src="/assets/icon/cake.png" alt="icon_birthdate" />
            11 FEB 1994
            </div>
        </div>
        ...
        <div className="grid gap-2">
            ...
            <img src="/assets/icon/fb.png" alt="icon_facebook" />
            Facebook
            </a>
            ...
            <img src="/assets/icon/ig.png" alt="icon_instagram" />
            Instagram
            </a>
            ...
            target="_blank">
            <img src="/assets/icon/notion.png" alt="icon_notion" />
            Notion</a>
            ...
            target="_blank">
            <img src="/assets/icon/github.png" alt="icon_githup" />
            GitHub 
            </a>
